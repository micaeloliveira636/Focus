# Carrossel: "Indicação não é estratégia"

> Direção: Claude (diretor de design). Padrão: banco DESCRICOES.md + seção 13 do playbook.
> Público: dono de negócio local estruturado (35-45, fatura bem) que vive de indicação.
> Tese: indicação você não controla. Canal de vendas, sim. (Leva pra oferta da Focus.)
> Tom: narrativo, direto, sem jargão de guru. Sem travessão. "seu/sua".
...
### Slide 1 — CAPA (imagem A)
- Kicker: `PRA QUEM VIVE DE INDICAÇÃO`
- Herói: `INDICAÇÃO NÃO É ESTRATÉGIA`
- Sub: `é sorte com outro nome.`
- Pílula: `ARRASTA →`

### Slide 2 — O sintoma (imagem A)
- Herói: `TEM MÊS QUE CHOVE. TEM MÊS QUE SECA.`
- Corpo: `Entra cliente de todo lado, e do nada o telefone para. E você nunca sabe qual vai ser o próximo mês.`

### Slide 3 — O problema real (imagem A)
- Herói (meio): `O PROBLEMA NÃO É O SEU SERVIÇO`
- Corpo: `Você é bom no que faz. Seus clientes voltam e te indicam. O problema é que você entregou o seu faturamento pra sorte dos outros lembrarem de você.`

### Slide 4 — O princípio (imagem A)
...
- Corpo: `É isso que presença digital e tráfego fazem. Cliente entrando não quando alguém lembra de você, mas quando você decide.`

### Slide 7 — Na prática (imagem A)
- Herói (meio): `VOCÊ ESCOLHE O VOLUME`
- Corpo: `O jogo vira. Você para de esperar o telefone tocar e passa a escolher quantos clientes quer atender esse mês.`

### Slide 8 — CTA (roxo em massa, só design)
- Lobo branco centralizado (~150px)
- Herói: `CANSOU DE VIVER NA SORTE?`
- Corpo: `Vem montar com a Focus o canal de vendas que não depende de ninguém lembrar de você.`
- Assinatura: `@focusprogress`
